...
2. Project-specific design system file.
3. UI UX Pro Max for responsive UX, component and accessibility guidance.
4. Taste Skill for premium editorial art direction.
5. Frontend design skill for technical implementation.
6. Hallmark and Anti-Slop as audit/review gates.
7. Design Motion Principles for restrained motion after layout is stable.

## Workflow

1. Use Hallmark `study` mode on references/screenshots; extract design DNA without copying.
2. Use UI UX Pro Max to create `design-system/the-brokerage-advisory/MASTER.md` and page override files.
3. Apply Taste Skill with:
   - Design variance: 5/10
   - Motion intensity: 3/10
   - Visual density: 4/10
4. Build original components/pages using the approved system.
5. Use Design Motion Principles after layouts are stable.
6. Audit with Hallmark and Anti-Slop before launch.
